...
def run_all():
    ...
    parser = argparse.ArgumentParser(prog='pymol_image', formatter_class=argparse.RawTextHelpFormatter,
                                     description=f"""It creates images of the residue with map cutoff using pymol \n
    Few example two run the code: \n\n
    1. pymol_image -r 5b6v.pdb -m FO-FO.ccp4 -resi 'resi 182+216+300' -all True -o output_all -s 3.0 -c 1.6 \n\n
    2. pymol_image -r 5b6v.pdb -m FO-FO.ccp4 -resi 'resi 182+216+300' -p True -o output_p \n\n
    3. pymol_image -r 5b6v.pdb -m FO-FO.ccp4 -resi 'resi 182+216+300' -n True -o output_n \n\n
    4. rpymol_image -r 5b6v.pdb -m FO-FO.ccp4 -resi 'resi 182+216+300' -n True -o output_n  -x 90 -y 90 -z 90\n\n
